// Simple test server for development - run with: node test-server.js
...
const sampleProducts = [
  ...
  // Sample SAPTNOVA product for testing existing components
  {
    ...
    "name": "SAPTNOVA - Ayurvedic Liver Care Capsules",
    "tagline": "Naturally Formulated for Liver & Enzyme Support",
    ...
    "benefits": [
      ...
      {
        "text": "Improves digestion and metabolism",
        "id": 2
      },
      {
        "text": "Enhances enzyme function",
        "id": 3
      },
      {
        "text": "Protects against oxidative damage",
        "id": 4
      }
    ],
    "ingredients": [
      {
        ...
        "quantity": "150mg",
        "description": "Supports liver health and aids in detoxification processes",
        "id": 1
      },
      {
        "name": "Punarnava",
        ...
        "quantity": "120mg",
        "description": "Helps reduce inflammation and supports kidney function",
        "id": 2
      },
      {
        "name": "Ashwagandha",
        "latin": "Withania somnifera",
        "quantity": "100mg",
        "description": "Adaptogenic herb that helps reduce stress and boost energy",
        "id": 3
      }
    ]
  }
...
server.listen(PORT, '127.0.0.1', () => {
  ...
  console.log('🔄 Your React app should now be able to fetch data!');
});